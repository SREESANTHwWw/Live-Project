...
const SignUpComponent = () => {
  ...
  const handleSubmit =async (e) => {
    ...
    axios.post(`${server}/registration.php`, {
      shopname:shopName,
      owner:ownerName,
...
console.log( typeof(type,shopName,ownerName,phoneNumber,address,gstNumber,username,password,pincode,city,whatsApp,selectedCity));

  return (
    <div className="w-full h-screen flex justify-center items-center">
      <div className="w-[60rem] sm:h-[40rem] h-full bg-slate-200 flex flex-col rounded-md gap-10  shadow-lg ">
        <div className="w-full h-[4rem]  flex flex-col justify-center items-center">
        ...
        <div className=" gap-5 flex justify-end items-center w-[20rem] h-[3rem] bg-white rounded-xl shadow-lg outline-none ">
        <input
                className="w-[20rem] h-[3rem] rounded-xl shadow-lg outline-none focus:border-blue-950 placeholder:text-center px-7 "
                type="text"
                placeholder="Address"
          ...
          <div className="w-full h-[2rem] relative bottom-6  flex justify-center items-center bg-slate-200">
